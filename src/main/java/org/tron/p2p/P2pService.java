...
public class P2pService {
   ...
   *     duplicate-peer checks are handled by {@link ChannelManager#checkPeer(Channel)} before
   *     registration. Application code should validate node ID consistency instead of updating it.
   */
  @Deprecated
